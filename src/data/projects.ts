...
export const projects: Project[] = [
  ...
  },
  {
    id: '2',
    name: '个人作品集网站',
    description: '基于 React 18 + TypeScript + TailwindCSS 构建的现代化响应式个人作品集网站。项目使用 Vite 5 作为构建工具，通过 React Router v6 实现多页面路由（首页、关于、项目列表、项目详情、联系我共 5 个页面），借助 Framer Motion 实现滚动入场动画、页面切换过渡及悬浮交互效果，采用 Lucide React 提供统一图标体系，整体追求流畅的视觉体验与高质量的代码工程规范。',
    image: '/images/portfolio.jpg',
    category: '前端开发',
    techStack: ['React', 'TypeScript', 'TailwindCSS', 'Vite', 'React Router', 'Framer Motion', 'Lucide React'],
    achievements: [
